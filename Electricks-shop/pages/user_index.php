    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by KiTech Solutios, Inc." data-placement="bottom" target="">
                    Mutsec Website
                </a>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/Favicons/logos.png" alt="Circle Image" class="rounded-circle">
                        <br><br>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Ksh<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You by <a href="https://github.org/">Github</a> | Thanks to Github community</li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
                    ...
                    </script>, Designed and Coded by KiTech Solutions, Inc.
                </div>
            </div>
        </footer>
    </div>
